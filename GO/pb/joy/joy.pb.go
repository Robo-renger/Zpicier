...
type JoystickRequest struct {
	...
	AxisZ         float64                `protobuf:"fixed64,4,opt,name=axis_z,json=axisZ,proto3" json:"axis_z,omitempty"`
	...
	Yaw           float64                `protobuf:"fixed64,7,opt,name=yaw,proto3" json:"yaw,omitempty"`
...
func (x *JoystickRequest) GetAxisZ() float64 {
	if x != nil {
		return x.AxisZ
	}
	return 0
...
const file_joy_proto_rawDesc = "" +
	"\n" +
	"\tjoy.proto\x12\bjoystick\"\x90\x02\n" +
	...
	"\x06axis_y\x18\x03 \x01(\x01R\x05axisY\x12\x15\n" +
	"\x06axis_z\x18\x04 \x01(\x01R\x05axisZ\x12\x12\n" +
	"\x04roll\x18\x05 \x01(\x01R\x04roll\x12\x14\n" +
	"\x05pitch\x18\x06 \x01(\x01R\x05pitch\x12\x10\n" +
	"\x03yaw\x18\a \x01(\x01R\x03yaw\x1a:\n" +
